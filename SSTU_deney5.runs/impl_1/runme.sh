...
HD_PWD='C:/Users/ahmet/Projects/Vivado/sstu/SSTU_deney5/SSTU_deney5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log eight_bit_register.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source eight_bit_register.tcl -notrace
