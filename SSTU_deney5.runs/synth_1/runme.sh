...
HD_PWD='C:/Users/ahmet/Projects/Vivado/sstu/SSTU_deney5/SSTU_deney5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log eight_bit_register.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source eight_bit_register.tcl
